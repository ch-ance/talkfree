...
const UserControls = () => {
  ...
  return (
    <div class="bg-gray-925 py-2 px-2 flex items-center justify-between">
      <div class="flex items-center">
        ...
        <div class="text-xs ml-2">
          <div class="text-white">{identity().public?.alias}</div>
          <div class="text-gray-500 text-xxs">{identity().public?.alias}</div>
        </div>
      </div>
